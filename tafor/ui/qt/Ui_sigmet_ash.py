...
class Ui_Editor(object):
    def setupUi(self, Editor):
        ...
        self.gridLayout_5.addWidget(self.formatLabel, 0, 0, 1, 1)
        self.format = QtWidgets.QComboBox(self.extentGroup)
        self.format.setObjectName("format")
        self.format.addItem("")
        self.format.setItemText(0, "")
        self.format.addItem("")
        self.format.setItemText(1, "SFC")
        self.gridLayout_5.addWidget(self.format, 1, 0, 1, 1)
