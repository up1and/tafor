...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.tab_recent)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.recent_text = QtWidgets.QTextBrowser(self.tab_recent)
        self.recent_text.setObjectName("recent_text")
        self.verticalLayout_4.addWidget(self.recent_text)
        ...
        self.taf_table.setColumnCount(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.post_menu.setTitle(_translate("MainWindow", "发报"))
        self.setting_menu.setTitle(_translate("MainWindow", "设置"))
        self.help_menu.setTitle(_translate("MainWindow", "关于"))
        self.taf_action.setText(_translate("MainWindow", "TAF"))
        self.trend_action.setText(_translate("MainWindow", "趋势"))
        self.sigmet_action.setText(_translate("MainWindow", "SIGMET"))
