...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setTabOrder(self.fir, self.trend_sign)
        Dialog.setTabOrder(self.trend_sign, self.weather1)
        Dialog.setTabOrder(self.weather1, self.add_weather1_button)
        Dialog.setTabOrder(self.add_weather1_button, self.del_weather1_button)
        Dialog.setTabOrder(self.del_weather1_button, self.weather1_list)
        Dialog.setTabOrder(self.weather1_list, self.weather2)
        Dialog.setTabOrder(self.weather2, self.add_weather2_button)
        Dialog.setTabOrder(self.add_weather2_button, self.del_weather2_button)
        Dialog.setTabOrder(self.del_weather2_button, self.weather2_list)
        ...
        Dialog.setTabOrder(self.tabWidget, self.taf)
        Dialog.setTabOrder(self.taf, self.sigmet)
        Dialog.setTabOrder(self.sigmet, self.airmet)
        Dialog.setTabOrder(self.airmet, self.trend)
        Dialog.setTabOrder(self.trend, self.clock)
        ...
        Dialog.setTabOrder(self.warn_taf_time, self.run_on_start)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.trend_sign_label.setText(_translate("Dialog", "趋势识别码"))
        self.trend_sign.setPlaceholderText(_translate("Dialog", "TREND"))
        self.weather_group.setTitle(_translate("Dialog", "天气现象备案"))
        self.weather1.setPlaceholderText(_translate("Dialog", "无强度变化的天气现象"))
        self.add_weather1_button.setText(_translate("Dialog", "+"))
        self.del_weather1_button.setText(_translate("Dialog", "—"))
        self.weather2.setPlaceholderText(_translate("Dialog", "有强度变化的天气现象"))
        self.add_weather2_button.setText(_translate("Dialog", "+"))
        self.del_weather2_button.setText(_translate("Dialog", "—"))
        ...
        self.address_group.setTitle(_translate("Dialog", "发报地址"))
        self.taf.setPlaceholderText(_translate("Dialog", "发报地址请以空格分隔"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_taf), _translate("Dialog", "TAF"))
        self.sigmet.setPlaceholderText(_translate("Dialog", "发报地址请以空格分隔"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_sigmet), _translate("Dialog", "SIGMET"))
        self.airmet.setPlaceholderText(_translate("Dialog", "发报地址请以空格分隔"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_airmet), _translate("Dialog", "AIRMET"))
        self.trend.setPlaceholderText(_translate("Dialog", "发报地址请以空格分隔"))
        ...
        self.clock_time.setPlaceholderText(_translate("Dialog", "单位分钟"))
        ...
        self.warn_taf_time.setPlaceholderText(_translate("Dialog", "单位分钟"))
        self.call_service_url_label.setText(_translate("Dialog", "请求地址"))
        self.call_service_url.setPlaceholderText(_translate("Dialog", "URL"))
        self.call_service_auth_label.setText(_translate("Dialog", "认证"))
        self.call_service_auth.setPlaceholderText(_translate("Dialog", "AUTH"))
        self.contract_group.setTitle(_translate("Dialog", "联系人"))
        self.person_name.setPlaceholderText(_translate("Dialog", "姓名"))
        self.person_phone_number.setPlaceholderText(_translate("Dialog", "电话"))
        self.add_person_button.setText(_translate("Dialog", "+"))
        self.del_person_button.setText(_translate("Dialog", "—"))
        ...
        self.select_contract_label.setText(_translate("Dialog", "当前设置告警号码"))
