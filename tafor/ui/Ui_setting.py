...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_6.addWidget(self.clock_volume, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_trend), _translate("Dialog", "趋势"))
