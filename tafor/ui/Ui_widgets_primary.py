...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.weather1_combobox = QtWidgets.QComboBox(Form)
        self.weather1_combobox.setObjectName("weather1_combobox")
        self.main_layout.addWidget(self.weather1_combobox, 3, 5, 1, 1)
        self.weather2_combobox = QtWidgets.QComboBox(Form)
        self.weather2_combobox.setObjectName("weather2_combobox")
        self.main_layout.addWidget(self.weather2_combobox, 3, 6, 1, 1)
        self.temp_min = QtWidgets.QLineEdit(Form)
        self.temp_min.setObjectName("temp_min")
        self.main_layout.addWidget(self.temp_min, 6, 10, 1, 1)
        ...
        self.temp_max = QtWidgets.QLineEdit(Form)
        self.temp_max.setObjectName("temp_max")
        self.main_layout.addWidget(self.temp_max, 6, 9, 1, 1)
        ...
        self.cor_combobox = QtWidgets.QComboBox(self.group_cls)
        self.cor_combobox.setObjectName("cor_combobox")
        self.gridLayout_5.addWidget(self.cor_combobox, 0, 2, 1, 1)
        self.amd = QtWidgets.QRadioButton(self.group_cls)
        self.amd.setObjectName("amd")
        self.gridLayout_5.addWidget(self.amd, 0, 3, 1, 1)
        self.amd_combobox = QtWidgets.QComboBox(self.group_cls)
        self.amd_combobox.setObjectName("amd_combobox")
        self.gridLayout_5.addWidget(self.amd_combobox, 0, 4, 1, 1)
        self.cnl = QtWidgets.QRadioButton(self.group_cls)
        self.cnl.setObjectName("cnl")
        self.gridLayout_5.addWidget(self.cnl, 0, 5, 1, 1)
        self.cnl_combobox = QtWidgets.QComboBox(self.group_cls)
        self.cnl_combobox.setObjectName("cnl_combobox")
        self.gridLayout_5.addWidget(self.cnl_combobox, 0, 6, 1, 1)
        ...
        self.temp_min_label.setBuddy(self.temp_min)
        self.vis_label.setBuddy(self.vis)
        self.weather1_label.setBuddy(self.weather1_combobox)
        ...
        self.temp_max_label.setBuddy(self.temp_max)
        self.weather2_label.setBuddy(self.weather2_combobox)
        ...
        Form.setTabOrder(self.cor, self.cor_combobox)
        Form.setTabOrder(self.cor_combobox, self.amd)
        Form.setTabOrder(self.amd, self.amd_combobox)
        Form.setTabOrder(self.amd_combobox, self.cnl)
        Form.setTabOrder(self.cnl, self.cnl_combobox)
        Form.setTabOrder(self.cnl_combobox, self.date)
        ...
        Form.setTabOrder(self.vis, self.weather1_combobox)
        Form.setTabOrder(self.weather1_combobox, self.weather2_combobox)
        Form.setTabOrder(self.weather2_combobox, self.cloud1)
        ...
        Form.setTabOrder(self.nsc, self.temp_max)
        Form.setTabOrder(self.temp_max, self.temp_min)
        Form.setTabOrder(self.temp_min, self.becmg1_checkbox)
