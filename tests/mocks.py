class MockConfig(object):
    ...
    config = {
        ...
        'Interface/RPC': 'true',
        'Interface/WebApiURL': 'http://127.0.0.1:8000/messages/yuso',
        'Monitor/WarnTAFTime': '30',
        'Monitor/WarnTAFVolume': 60,
        'Monitor/RemindTAF': 'true',
        'Monitor/RemindTAFVolume': 60,
        'Monitor/RemindTrend': 'true',
        'Monitor/RemindTrendVolume': 60,
        'Message/FIR': 'YUDD SHANLON FIR',
        ...
        'Interface/LayerApiURL': 'http://127.0.0.1:8000/layers',
        'Monitor/RemindSIGMET': 'true',
        'Monitor/RemindSIGMETVolume': 60,
